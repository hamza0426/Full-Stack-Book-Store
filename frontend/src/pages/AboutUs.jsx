      ...
      <div className="min-h-screen py-12" style={{ backgroundColor: "#FEFAE0" }}>
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold mb-4" style={{ color: "#BC6C25" }}>About Our FahamBooks</h1>
            <div className="w-24 h-1 mx-auto mb-6" style={{ backgroundColor: "#DDA15E" }}></div>
          ...
          <div className="mb-20 grid gap-8 md:grid-cols-2">
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-2xl font-bold mb-4" style={{ color: "#283618" }}>📚 Our Vision</h3>
              <p className="mb-6" style={{ color: "#606C38" }}>
                Create a seamless digital experience that mirrors the joy of physical book browsing,
                enhanced with smart recommendations and community features.
              </p>
            </div>
            
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-2xl font-bold mb-4" style={{ color: "#283618" }}>🔧 Key Features</h3>
              <ul className="list-disc pl-6 space-y-2" style={{ color: "#606C38" }}>
          ...
          <div className="space-y-16">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="md:w-2/3">
                <h2 className="text-3xl font-bold mb-2" style={{ color: "#BC6C25" }}>Muhammad Hamza Owais</h2>
                <p className="text-lg mb-4" style={{ color: "#606C38" }}>Lead Frontend Architect</p>
                <p className="mb-4" style={{ color: "#283618" }}>
                  Specializes in React ecosystem and UI/UX design, with focus on creating 
                  intuitive user interfaces and seamless interactions.
                </p>
                <div className="space-y-1">
                  <p className="flex items-center gap-2" style={{ color: "#606C38" }}>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="md:w-2/3">
                <h2 className="text-3xl font-bold mb-2" style={{ color: "#BC6C25" }}>Muhammad Fahad</h2>
                <p className="text-lg mb-4" style={{ color: "#606C38" }}>Backend & DevOps Engineer</p>
                <p className="mb-4" style={{ color: "#283618" }}>
                  Expert in Node.js microservices and cloud infrastructure, ensuring 
                  high availability and secure data management.
                </p>
                <div className="space-y-1">
                  <p className="flex items-center gap-2" style={{ color: "#606C38" }}>
                    <span>📧</span> fahad@bookiverse.com
                  </p>
                  <p className="flex items-center gap-2" style={{ color: "#606C38" }}>
                    <span>📱</span> +92 300 7654321
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-20 text-center">
            <h3 className="text-2xl font-bold mb-6" style={{ color: "#283618" }}>
