...
const ViewBookDetails = () => {
    ...
    return (
        <>
        {Data && (
            <div className='px-4 md:px-12 py-8 bg-bg1 flex flex-col md:flex-row gap-8'>
        ...
        {!Data && <div className="h-screen bg-zinc-900 flex items-center justify-center"><Loader />{" "}
        </div>}
        </>
    );
}
